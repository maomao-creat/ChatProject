        ...
        TIMFriendshipManager.getInstance().getUsersProfile(list, true, new TIMValueCallBack<List<TIMUserProfile>>() {
            ...
            public void onSuccess(List<TIMUserProfile> timUserProfiles) {
                ...
                if (timUserProfiles == null) {
                    ...
                    usernameText.setText(!TextUtils.isEmpty(timUserProfiles.get(0).getNickName()) ? timUserProfiles.get(0).getNickName() : msg.getFromUser());
                    if (!TextUtils.isEmpty(timUserProfiles.get(0).getFaceUrl()) && !msg.isSelf()) {
                        List<String> urllist = new ArrayList<>();
                        urllist.add(TUIKitConfigs.getbase(timUserProfiles.get(0).getFaceUrl()));
...
//                urllist.add(TUIKitConfigs.getbase(profile.getFaceUrl()) );
//                leftUserIcon.setIconUrls(urllist);
//                urllist.clear();
//            }
//        }
...
//                urllist.add(selfInfo.getFaceUrl());
                urllist.add(TUIKitConfigs.getbase(selfInfo.getFaceUrl()));
