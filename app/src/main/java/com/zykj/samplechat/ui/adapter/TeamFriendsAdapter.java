 ...
 */
public class TeamFriendsAdapter extends BaseAdapter<TeamFriendsAdapter.VHolder, Friend, TeamFriendsPresenter> {

    public TeamFriendsAdapter(Context context, TeamFriendsPresenter teamFriendsPresenter) {
        super(context, teamFriendsPresenter);
        isAddFooter = false;
    }
    ...
    public void bindData(VHolder holder, int position) {
        ...
        holder.team_name.setText(model.RemarkName.equals("")?model.NicName:model.RemarkName);
