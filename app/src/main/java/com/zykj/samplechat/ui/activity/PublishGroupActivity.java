...
import com.zykj.samplechat.presenter.PublishGroupPresenter;
import com.zykj.samplechat.ui.activity.base.ToolBarActivity;
import com.zykj.samplechat.ui.view.PublishGroupView;
 ...
 */
public class PublishGroupActivity extends ToolBarActivity<PublishGroupPresenter> implements PublishGroupView {
    ...
    protected void action() {
        ...
        showDialog();
        presenter.UpLoadImageBefore(list);
    ...
    @Override
    public PublishGroupPresenter createPresenter() {
        return new PublishGroupPresenter();
    }
        ...
        for (int i = 0; i < subList.size(); i++) {
            ...
            imgWraper.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(PublishGroupActivity.this, PicsActivity.class);
