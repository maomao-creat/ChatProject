 ...
 */
public class FriendsTuijianAdapter extends BaseAdapter<FriendsTuijianAdapter.VHolder, Friend, FriendsTuijianPresenter> {

    public FriendsTuijianAdapter(Context context, FriendsTuijianPresenter friendsTuijianPresenter) {
        super(context, friendsTuijianPresenter);
        isAddFooter = false;
    }
