...
public class TiXianJiLuActivity extends ToolBarActivity<WalleJiLuPresenter> implements SendJiLuView, Listener.OnItemClickListener, Listener.LoadMoreListener {
    ...
    void chushihualb() {
        ...
        rvu = new RecyclerViewUtil(getWindow().getDecorView(), this, this, this, new MainListAdapter(2, this));//new MainListAdapter();  这个是适配器
...
//                mMainListAdapter.addData(getPageData(5));
    ...
    void sendliebiao() {//提现记录
        HttpUtils.GetCashList(new SubscriberRes<TiXianBean>(rvu.getRecyclerView()) {
            @Override
            public void onSuccess(TiXianBean userBean) {
