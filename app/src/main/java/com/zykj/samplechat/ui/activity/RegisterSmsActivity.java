 ...
 */
public class RegisterSmsActivity extends ToolBarActivity<RegisterSmsPresenter> implements RegisterSmsView {
    ...
    public void ls_btn() {
        ...
        if (StringUtil.isMobile(phoneNumber)) {
            startActivity(RegisterCheckActivity.class, new Bun().putString("phoneNumber", phoneNumber).ok());
