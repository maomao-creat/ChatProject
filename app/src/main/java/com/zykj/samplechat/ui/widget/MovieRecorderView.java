...
//        mHeight = a.getInteger(R.styleable.MovieRecorderView_height, 240);// 默认240
        ...
        mRecordMaxTime = a.getInteger(
                R.styleable.MovieRecorderView_record_max_time, 20);// 默认为20
...
//        mMediaRecorder.setVideoFrameRate(3); // 每秒3帧
//        mMediaRecorder
...
//
//        mMediaRecorder
//                .setOutputFile(mVecordFile.getAbsolutePath());
//        mMediaRecorder.prepare();// 预期准备
//	        try {
//	            mMediaRecorder.start();
//	        } catch (IllegalStateException e) {
//	            e.printStackTrace();
//	            ToolsUtil.print("----", ""+e.toString()+"=============IllegalStateException");
//	        } catch (RuntimeException e) {
//	            e.printStackTrace();
//	            ToolsUtil.print("----", ""+e.toString()+"=============RuntimeException");
//	        } catch (Exception e) {
//	            e.printStackTrace();
//	            ToolsUtil.print("----", ""+e.toString()+"=============Exception");
//	        }
//	
//	        record = true;
    }
