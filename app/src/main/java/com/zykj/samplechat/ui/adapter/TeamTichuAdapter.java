 ...
 */
public class TeamTichuAdapter extends BaseAdapter<TeamTichuAdapter.VHolder, Friend, TeamTichuPresenter> {

    public TeamTichuAdapter(Context context, TeamTichuPresenter teamTichuPresenter) {
        super(context, teamTichuPresenter);
        isAddFooter = false;
    }
    ...
    public void bindData(VHolder holder, int position) {
        ...
        if(model.MemnerId == new UserUtil(context).getUserId()){
