package com.zykj.samplechat.rongc.utils;
...
public class Contant {
    ...
    public static int DEFAULT_DURATION_MAX_LIMIT_TWO = 20;

    public static int DEFAULT_DURATION_LIMIT_MIN = 2;
    public static int DEFAULT_DURATION_LIMIT_MIN_TWO = 5;
    /**
     * 默认码率
     */
    ...
    public static String space = "comzykjchatproject"; //存储目录 建议使用uid cid之类的信息
