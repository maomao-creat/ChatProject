...
import com.zykj.samplechat.ui.activity.LoginExistActivity;
		...
		//if (MainActivity.isForeground) {
			...
			if (!StringUtil.isEmpty(extras)) {
				try {
					...
					Iterator<String> it =  json.keys();
					if("200".equals(json.optString("flg")) || "201".equals(json.optString("flg"))){
						//打开自定义的Activity
			...
			msgIntent.putExtra("notifactionId", bundle.getInt(JPushInterface.EXTRA_NOTIFICATION_ID));
